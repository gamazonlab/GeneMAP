...
df <- fread("/ru-auth/local/home/akhan01/GeneMAP/AlphaMissense_hg38.tsv")
...
write.xlsx(as_tibble(genome), "/ru-auth/local/home/akhan01/GeneMAP/20230924_AlphaMissenseScore.xlsx")
